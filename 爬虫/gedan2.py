...
gedan_url = 'https://www.kugou.com/yy/special/index/1-3-0.html'
# api的url
...
# 设置i，同时设置tag_id, gedan_url
i = 11
driver.get(gedan_url)
gedan_list = driver.find_elements(by=By.XPATH, value="//ul[@id='ulAlbums']/li")
gedan = gedan_list[i]
gedan_click = gedan.find_elements(by=By.XPATH, value="./div[@class='pic']/a")[0]
gedan_click.click()
music_list = driver.find_elements(by=By.XPATH, value="//div[@id='songs']/ul/li/a")
