...
artist_url = 'https://www.kugou.com/yy/singer/index/1-all-4.html'
# api的url
...
# 设置i，j，同时设置tag_id, artist_type, artist_location, artist_url
i = 3
j = 2
...
try:
    ...
    cursor.execute(query=artist_sql,
                   args=[artist_id, artist_name, artist_type, artist_location, artist_img,
                         artist_description])
    connection.commit()
except Exception:
