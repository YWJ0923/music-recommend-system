...
# 找到风格电台，点击
feng_ge_fm = driver.find_element(by=By.XPATH, value="//div[@id='radioList']/dl/dd/a[contains(text(),'风格电台')]")
feng_ge_fm.click()
# 获取所有该类型电台，除去民谣，蒸汽波，布鲁斯，新民歌
fm_list = driver.find_elements(by=By.XPATH, value="//dl[@id='rightRadioList']/dd")

for i in range(12):
    if i == 8 or i == 9 or i == 1 or i == 3 or i == 4:
        continue
    fm = fm_list[i]
    # 标签id，名字
